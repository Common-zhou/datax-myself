package com.beiwu.utils;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.beiwu.CusException;
...
public class Configuration {
    ...
    public static Configuration from(String json) {
        ...
        try {
            ...
            throw new CusException(e.toString());
        }
    ...
    public static Configuration from(File file) {
        try {
            ...
            throw new CusException(
                    String.format("Incorrect configuration information. The configuration file [%s] you provided does not exist.Please check your configuration file.", file.getAbsolutePath()));
        } catch (IOException e) {
            throw new CusException(
                    String.format("Error in configuration information. The configuration file [%s] you supplied failed to read. Error cause: %s.Please check the permission Settings for your configuration file.",
    ...
    public static Configuration from(InputStream is) {
        try {
            ...
            throw new CusException(
                    String.format("Error in configuration information. The configuration file [%s] you supplied failed to read. Error cause: %s.Please check the permission Settings for your configuration file.", e));
        }
    }
    ...
    public String getNecessaryValue(String key) {
        ...
        if (StringUtils.isBlank(value)) {
            throw new CusException(
                    String.format("You provided the configuration file incorrectly. [%s] is a required parameter. It is not allowed to be blank or blank.", key));
        }
    ...
    public Character getChar(final String path) {
        ...
        try {
            ...
            throw new CusException(
                    String.format("Error reading configuration file for task.Because the profile path [%s] value is illegal, the character type is expected to be: %s. Please check your configuration and make changes.", path,
                            e.getMessage()));
        }
    }
    ...
    public Boolean getBool(final String path) {
        ...
        if (null == result) {
            ...
            throw new CusException(
                    String.format("The configuration information you provided is incorrect because the value [%s] obtained from [%s] cannot be converted to a bool.Check the configuration of the source table and modify it accordingly.",
                            path, result));
        }
    ...
    public Integer getInt(final String path) {
        ...
        try {
            ...
            throw new CusException(
                    String.format("Error reading configuration file for task.The configuration file path [%s] value is not valid and is expected to be an integer type: %s. Please check your configuration and make changes.", path,
                            e.getMessage()));
        }
    }
    ...
    public Double getDouble(final String path) {
        ...
        try {
            ...
            throw new CusException(
                    String.format("Error reading configuration file for task.The configuration file path [%s] value is not valid and is expected to be of floating-point type: %s. Please check your configuration and make changes.", path,
                            e.getMessage()));
        }
    }
    ...
    public Object remove(final String path) {
        ...
        if (null == result) {
            throw new CusException(
                    String.format("The configuration file for Key[%s] does not exist. This is a code error.Please contact someone on the Datax team.", path));
        }
    ...
    private void setObject(final String path, final Object object) {
        ...
        throw new CusException(
                String.format("The value [%s] cannot be matched to the value [%s] you provided. This exception represents a system programming error. Please contact the DataX development team!",
    ...
    Object buildObject(final List<String> paths, final Object object) {
        if (null == paths) {
            throw new CusException(
                    "PATH cannot be NULL, this exception represents a system programming error, please contact the DataX development team!");
        }
        ...
        for (int i = paths.size() - 1; i >= 0; i--) {
            ...
            throw new CusException(
                    String.format(
                            "An invalid value type [%s] occurred in the path [%s]. This exception represents a system programming error. Please contact the DataX development team!.",
    ...
    Object setObjectRecursive(Object current, final List<String> paths,
        ...
        throw new CusException(
                "This exception represents a system programming error, please contact the Datax development team!");
    }
    ...
    private Object findObjectInMap(final Object target, final String index) {
        ...
        if (!isMap) {
            throw new IllegalArgumentException(String.format(
                    "The configuration file you provided is incorrect.The path [%s] needs to configure a JSON formatted Map object, but the node finds that the actual type is [%s].Please check your configuration and make changes.",
        ...
        if (null == result) {
            throw new IllegalArgumentException(String.format(
                    "The configuration file you provided is incorrect.The path [%s] value is NULL, DataAX is not aware of the configuration.Please check your configuration and make changes.", index));
        }
    ...
    private Object findObjectInList(final Object target, final String each) {
        ...
        if (!StringUtils.isNumeric(index)) {
            throw new IllegalArgumentException(
                    String.format(
                            "System programming error, list subscript must be numeric type, but the node found the actual type is [%s], this exception represents system programming error, please contact the DataX development team!",
                            index));
        }
    ...
    private void checkPath(final String path) {
        if (null == path) {
            throw new IllegalArgumentException(
                    "System programming error, this exception represents system programming error, please contact the DataX development team!.");
        }

        for (final String each : StringUtils.split(".")) {
            if (StringUtils.isBlank(each)) {
                throw new IllegalArgumentException(String.format(
                        "System programming error, path [%s] is not valid, white space characters cannot appear between path levels.", path));
            }
        }
    }
    ...
    private static void checkJSON(final String json) {
        if (StringUtils.isBlank(json)) {
            throw new CusException(
                    "The configuration information is wrong. Because the configuration information you provided is not in a valid JSON format, the JSON cannot be blank.Please provide configuration information in standard JSON format.");
        }
    }
    ...
    private Configuration(final String json) {
        try {
            ...
            throw new CusException(
                    String.format("Incorrect configuration information. The configuration information you provided is not in valid JSON format: %s.Please provide configuration information in standard JSON format.", e.getMessage()));
        }
    }
